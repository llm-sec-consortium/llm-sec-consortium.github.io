...
const config = {
  title: 'LLM Security Consortium',
  tagline: '',
  favicon: 'img/kunkun.png',

  // Set the production url of your site here
  url: 'https://llm-sec-consortium.github.io',
  ...
  organizationName: 'llm-sec-consortium', // Usually your GitHub org/user name.
  projectName: 'llm-sec-consortium.github.io', // Usually your repo name.
